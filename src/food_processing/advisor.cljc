(ns food-processing.advisor
  "ProcessingAdvisor — proposes a food-processing operation (process,
  package, label, release) for a batch. Swappable: `mock-advisor`
...
(defn- infer
  ...
  {:op op
   ...
   :rationale (str "proposed " (name op) " for batch " (:batch-id request))})
...
(def ^:private system-prompt
  "You are a food-processing operations advisor. Given a machine-operator
   operation request, propose an :op, an honest :confidence (0.0-1.0), and a
   :stake (:low/:medium/:high). Never fabricate confidence you don't have.")
